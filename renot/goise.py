...
class GoiseSongData:
    ...
    def get_tres_string(self) -> str:
        ...
        output = \
        f"""[ext_resource type="Script" path="res://addons/goise/data/instrument.gd" id="{GoiseInstrument.script_id}"]\n""" \
        ...
        for instrument in self.instruments:
            new_steps, output_text = instrument.get_tres_string()
    ...
    def add_instrument(self, instrument: 'GoiseInstrument'):
        self.instruments.append(instrument)


class GoiseInstrument:
...
if __name__ == '__main__':
    ...
    for a in range(4):
        ...
        inst = GoiseInstrument(f'inst_{a}')
